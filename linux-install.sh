...
curl -L -O https://github.com/clojure/brew-install/releases/download/1.12.1.1561/clojure-tools-1.12.1.1561.tar.gz
tar xzf clojure-tools-1.12.1.1561.tar.gz
...
install -m644 clojure-tools/clojure-tools-1.12.1.1561.jar "$clojure_lib_dir/libexec/clojure-tools-1.12.1.1561.jar"
...
rm -rf clojure-tools
rm -rf clojure-tools-1.12.1.1561.tar.gz
